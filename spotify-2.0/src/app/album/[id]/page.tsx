...
import { CheckCircle2, Clock3, List, Play, Shuffle, User } from "lucide-react";
    ...
    <div className="h-full">
      <Header className="from-[#5038a0]/80 p-3">
        <div className="flex gap-6 p-2 pb-8">
          <Image
            src=""
            alt=""
            className="object-cover rounded shadow-xl size-60"
            width={240}
            height={240}
          />
          <div className="flex flex-col justify-end">
            <p className="text-sm font-medium">Album</p>
            <h1 className="my-4 text-6xl font-bold">Flower Boy</h1>
            <div className="flex items-center gap-2 text-sm text-zinc-500">
              ...
              <span>&#183; 2017</span>
              <span>&#183; 14 songs, 48 min 30 sec</span>
            </div>
          </div>
        </div>
      </Header>
      ...
      <div className="flex items-center justify-between px-6 pb-4">
        <div className="flex items-center gap-6">
          <button className="flex items-center p-3 transition bg-green-500 rounded-full cursor-pointer drop-shadow-md hover:scale-110">
            <FaPlay className="text-black" />
          </button>
          <button className="transition cursor-pointer text-zinc-400 hover:text-white hover:scale-105">
            <Shuffle className="size-7" />
          </button>
          <button className="transition cursor-pointer hover:scale-105">
            <CheckCircle2 className="text-black fill-green-600 size-8" />
          </button>
      ...
      <SongsTable>
        <SongsTable.Header>
          ...
          <SongsTable.HeaderCell className="px-3">Plays</SongsTable.HeaderCell>
          <SongsTable.HeaderCell>
