    ...
    <div className="h-full">
      <Header className="from-[#5038a0]/80 p-3">
        <div className="flex gap-6 p-2 pb-8">
          ...
          <div className="flex flex-col justify-end">
            ...
            <h1 className="my-4 text-6xl font-bold">Liked Songs</h1>
      ...
      <div className="flex items-center justify-between px-6 pb-4">
        <div className="flex items-center gap-6">
          <button className="flex items-center p-3 transition bg-green-500 rounded-full cursor-pointer drop-shadow-md translate hover:scale-110">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 transition bg-transparent cursor-pointer hover:scale-105 text-muted-foreground hover:text-white">
